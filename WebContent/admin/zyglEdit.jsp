...
<div align="center">
	<form id="admin_zyglEdit_editForm" method="post">
		<table class="tableForm">
			...
			<tr>
				<th>上级资源</th>
				<td colspan="3"><input id="admin_zyglEdit_pid" name="pid" class="easyui-combotree" data-options="url:'${pageContext.request.contextPath}/resourceController/allTreeNode.action',parentField : 'pid',lines : true" style="width: 370px;" /><img src="${pageContext.request.contextPath}/style/images/extjs_icons/cut_red.png" onclick="$('#admin_zyglEdit_pid').combotree('clear');" />
				</td>
			</tr>
		</table>
	</form>
